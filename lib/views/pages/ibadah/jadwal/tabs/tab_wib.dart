...
class TabWib extends StatefulWidget {
  IconData? icon;

  TabWib({Key? key}) : super(key: key);

  @override
  State<TabWib> createState() => _TabWibState();
}
...
class _TabWibState extends State<TabWib> with SingleTickerProviderStateMixin {
