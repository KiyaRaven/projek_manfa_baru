...
class ArtikelMuslim2Container extends StatefulWidget {
  const ArtikelMuslim2Container({super.key});

  @override
  State<ArtikelMuslim2Container> createState() =>
      _ArtikelMuslim2ContainerState();
}

class _ArtikelMuslim2ContainerState extends State<ArtikelMuslim2Container> {
  @override
  Widget build(BuildContext context) {
    return Container(
